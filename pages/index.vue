    ...
    <section class="relative overflow-hidden bg-black hero-section flex flex-col items-center justify-between h-screen">
      ...
      <div class="flex items-center justify-center space-x-8 mb-4 mt-8">
        ...
        <a 
          ...
          class="h-16 w-16 rounded-md bg-gray-800/80 border border-gray-700/50 flex items-center justify-center shadow-sm hover:bg-gray-700/80 transition-colors group"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-8 h-8 fill-gray-300 group-hover:fill-white transition-colors">
