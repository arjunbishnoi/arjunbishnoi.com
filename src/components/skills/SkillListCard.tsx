export function SkillListCard({ category, items }: { category: string, items: string[] }) {
  return (
    <div className="group relative rounded-[32px] bg-white dark:bg-[#111] border border-black/5 dark:max-sm:border-white/5 sm:dark:border-white/10 shadow-sm transition-all duration-500 hover:-translate-y-1 hover:shadow-md p-6 sm:p-8 h-full flex flex-col">
