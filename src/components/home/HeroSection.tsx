        ...
        <div className="w-full max-w-md mx-auto self-start mt-[clamp(2.4rem,5svh,3.3rem)] mb-6 flex flex-col items-center hero-mobile-main-shape-wrap">
          <div className="w-full neu-container overflow-hidden">
            ...
            <div className="grid grid-cols-2">
              ...
              <Link href="/ai" className={cn("flex items-center justify-center border-b neu-separator text-zinc-900 dark:text-zinc-100 font-medium text-[0.95rem] text-center active:bg-zinc-100/10 transition-colors", mobileGridRowClass)}>
                <div className="whitespace-nowrap">AI/ML</div>
              </Link>
              <Link href="/design" className={cn("flex items-center justify-center border-r border-b neu-separator text-zinc-900 dark:text-zinc-100 font-medium text-[0.95rem] text-center active:bg-zinc-100/10 transition-colors", mobileGridRowClass)}>
                <div className="whitespace-nowrap">Design</div>
              </Link>
              <a href={socialLinks.resume} download={socialLinks.resumeDownloadName} className={cn("flex items-center justify-center border-b neu-separator text-zinc-900 dark:text-zinc-100 font-medium text-[0.95rem] text-center active:bg-zinc-100/10 transition-colors", mobileGridRowClass)}>
            ...
            <div className="grid grid-cols-4">
              <a href={socialLinks.email} className={cn("flex items-center justify-center border-r neu-separator group active:bg-zinc-100/10 transition-colors", mobileGridRowClass)}>
              ...
              <a href={socialLinks.github} target="_blank" rel="noopener noreferrer" className={cn("flex items-center justify-center border-r neu-separator group active:bg-zinc-100/10 transition-colors", mobileGridRowClass)}>
                <div className="w-11 h-11 rounded-full flex items-center justify-center transition-colors text-zinc-500 dark:text-zinc-500 group-hover:text-zinc-900 dark:group-hover:text-zinc-100">
              ...
              <a href={socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className={cn("flex items-center justify-center group active:bg-zinc-100/10 transition-colors", mobileGridRowClass)}>
                <div className="w-11 h-11 rounded-full flex items-center justify-center transition-colors text-zinc-500 dark:text-zinc-500 group-hover:text-zinc-900 dark:group-hover:text-zinc-100">
                  <svg viewBox="0 0 24 24" className="block w-[1.6rem] h-[1.6rem] fill-current" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="hidden md:block w-full max-w-5xl mx-auto px-6 sm:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-4 md:gap-5">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-4 md:gap-5 aspect-[2.15/1] md:aspect-auto h-auto md:h-24 lg:h-28 order-7 md:order-5">
              ...
              >
                <svg viewBox="0 0 24 24" className="w-8 h-8 fill-zinc-500 dark:fill-zinc-500 group-hover:fill-zinc-900 dark:group-hover:fill-zinc-100 transition-colors duration-500" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                </svg>
              </a>
              <a
