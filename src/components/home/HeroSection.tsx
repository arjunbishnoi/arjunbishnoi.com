        ...
        <div className="w-[95%] sm:w-[94%] mx-auto mt-10 mb-0 flex flex-col items-center hero-mobile-main-shape-wrap">
          <div className="w-full neu-container overflow-visible aspect-[342/340] grid grid-rows-[40%_20%_20%_20%]">
              ...
              >
                <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none animate-color-shift">
                  ...
                  <div
                    ...
                    style={{
                      maskImage:
                        "radial-gradient(ellipse at center, black 30%, transparent 68%)",
                      WebkitMaskImage:
                        "radial-gradient(ellipse at center, black 30%, transparent 68%)",
                    }}
                  >
                    <div
                      className={`absolute -top-[14%] -left-[10%] w-[62%] h-[72%] rounded-full mix-blend-multiply ${viewAllBlobColors[0]} animate-lava [--drift-name:drift-orbit] [--drift-duration:8s] [--morph-name:morph] [--morph-duration:6s] [--color-duration:12s] [--glow-blur:74px] scale-125`}
                      style={{ filter: "blur(var(--glow-blur))" }}
                    />
                    <div
                      className={`absolute -top-[4%] right-[-12%] w-[58%] h-[68%] rounded-full mix-blend-multiply ${viewAllBlobColors[1]} animate-lava [--drift-name:drift-cross] [--drift-duration:10s] [--morph-name:morph-alt] [--morph-duration:7s] [--color-duration:14s] [--drift-delay:0.5s] [--color-delay:1s] [--glow-blur:80px] scale-120`}
                      style={{ filter: "blur(var(--glow-blur))" }}
                    />
                    <div
                      className={`absolute top-[30%] left-[18%] w-[48%] h-[55%] rounded-full mix-blend-multiply ${viewAllBlobColors[2]} animate-lava [--drift-name:drift-wide] [--drift-duration:9s] [--morph-name:morph] [--morph-duration:8s] [--color-duration:13s] [--drift-delay:0.4s] [--color-delay:1.5s] [--glow-blur:76px] scale-125`}
                      style={{ filter: "blur(var(--glow-blur))" }}
                    />
                    <div
                      className={`absolute bottom-[-14%] left-[4%] w-[56%] h-[66%] rounded-full mix-blend-multiply ${viewAllBlobColors[3]} animate-lava [--drift-name:drift-orbit] [--drift-duration:12s] [--morph-name:morph-alt] [--morph-duration:9s] [--color-duration:16s] [--drift-delay:1s] [--color-delay:2s] [--glow-blur:78px] scale-115`}
                      style={{ filter: "blur(var(--glow-blur))" }}
                    />
                    <div
                      className={`absolute bottom-[-10%] right-[2%] w-[52%] h-[60%] rounded-full mix-blend-multiply ${viewAllBlobColors[4]} animate-lava [--drift-name:drift-cross] [--drift-duration:11s] [--morph-name:morph] [--morph-duration:10s] [--color-duration:15s] [--drift-delay:1.2s] [--color-delay:2.5s] [--glow-blur:80px] scale-110`}
                      style={{ filter: "blur(var(--glow-blur))" }}
                    />
                    <div
                      className={`absolute top-[18%] left-[38%] w-[28%] h-[34%] rounded-full mix-blend-multiply ${viewAllBlobColors[5]} animate-lava [--drift-name:drift-wide] [--drift-duration:14s] [--morph-name:morph] [--morph-duration:8s] [--color-duration:18s] [--drift-delay:1.5s] [--glow-blur:54px] scale-140`}
                      style={{ filter: "blur(var(--glow-blur))" }}
                    />
                  </div>
                  <div
                ...
                <div className="relative z-10 h-full flex flex-col items-center justify-center text-center">
                  <div className="flex items-center gap-1.5">
                    <span className="text-[1.125rem] tracking-[-0.005em] font-semibold text-zinc-900">
                      View all projects
                    </span>
                    <ArrowUpRight
            ...
            <div className="grid grid-cols-2">
              <Link
                href="/apps"
                className="flex items-center justify-center border-r border-b neu-separator text-zinc-900 font-medium text-[0.95rem] text-center active:bg-zinc-100/10 transition-colors"
              >
                <div className="whitespace-nowrap">Mobile Apps</div>
              </Link>
              <Link
                href="/ai"
                className="flex items-center justify-center border-b neu-separator text-zinc-900 font-medium text-[0.95rem] text-center active:bg-zinc-100/10 transition-colors"
              >
            ...
            <div className="grid grid-cols-4">
              <Link
                href="#contact"
                className="flex items-center justify-center border-r neu-separator group active:bg-zinc-100/10 transition-colors"
              >
                <div className="w-11 h-11 rounded-full flex items-center justify-center transition-colors text-rose-500 group-hover:opacity-100 opacity-90">
                  <svg
                    viewBox="0 0 24 24"
                    className="block w-[1.4rem] h-[1.4rem] fill-current"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center group active:bg-zinc-100/10 transition-colors"
              >
          ...
          <div className="flex flex-col pt-8 pb-14 px-8 text-left">
            <div className="flex flex-col gap-8">
              ...
              <p className="text-[0.85rem] font-normal leading-[1.6] text-zinc-900 dark:text-zinc-300">
                I build cross-platform mobile apps at the intersection of AI and
                design. Functional, intelligent and crafted with precision.
                ...
                <div className="hero-education-card relative rounded-[28px] bg-[#f3f3f4] border border-zinc-200/40 dark:bg-transparent dark:border-transparent pt-3 pb-4 px-0 flex flex-col gap-3">
                  ...
                  <div className="relative pl-7 group">
                    ...
                    <div className="space-y-0">
                      <p className="text-[0.9rem] font-bold text-zinc-900 dark:text-zinc-100 tracking-tight leading-normal">
                      ...
                      <p className="text-[0.85rem] font-normal leading-normal text-zinc-900 dark:text-zinc-100">
                      ...
                      <div className="grid grid-cols-3 gap-y-7 gap-x-5 w-full">
                        {heroSkills.slice(0, 12).map((skill, i) => (
                          ...
                          >
                            ...
                            <span className="text-[0.55rem] font-bold text-zinc-600 dark:text-zinc-300 text-center leading-tight tracking-[0.02em]">
                              {skill.name}
                            </span>
                          </div>
                        ))}
            ...
            <div className="flex flex-col">
              <div className="hero-bio-card w-full h-full relative rounded-[40px] bg-white dark:bg-black border border-zinc-200/50 dark:border-white/10 flex flex-col overflow-hidden shadow-none">
                ...
                <div className="flex flex-col h-full p-8 pt-5 xl:p-10 xl:pt-7 pb-6 text-left overflow-hidden">
                  ...
                  {/* 3. Short Description */}
                  <p className="text-[0.85rem] xl:text-[0.9rem] font-normal leading-[1.6] text-zinc-900 dark:text-zinc-100 mb-12">
                    I build cross-platform mobile apps at the intersection of AI
                    and design. Functional, intelligent and crafted with
                    precision. Consistent, hands-on and always evolving.
                  </p>
                    ...
                    <div className="grid grid-cols-3 gap-y-7 gap-x-5 w-full">
                      {heroSkills.slice(0, 12).map((skill, i) => (
                        ...
                        >
                          ...
                          <span className="text-[0.55rem] xl:text-[0.6rem] font-bold text-zinc-600 dark:text-zinc-300 text-center leading-tight tracking-[0.02em]">
                            {skill.name}
                          </span>
                        </div>
                      ))}
            ...
            <div className="flex flex-col gap-6 xl:gap-7">
              ...
              <div className="w-full relative aspect-[4/5] neu-container overflow-visible rounded-[40px] xl:rounded-[40px] grid grid-rows-[40%_20%_20%_20%] shrink-0 min-h-0">
                  ...
                  >
                    ...
                    <div className="relative z-10 h-full flex flex-col items-center justify-center text-center">
                      <div className="flex items-center gap-2 xl:gap-2.5">
                        <span className="text-[1.2rem] xl:text-[1.3rem] tracking-[-0.005em] font-semibold text-zinc-900">
                          View all projects
                        </span>
                        <ArrowUpRight
                          className="w-5 h-5 xl:w-6 xl:h-6 text-zinc-900"
                          strokeWidth={2.5}
                        />
                      </div>
                    </div>
                ...
                <div className="grid grid-cols-2">
                  <Link
                    href="/apps"
                    className="flex items-center justify-center border-r border-b neu-separator text-zinc-900 font-normal text-[0.81rem] xl:text-[0.86rem] hover:bg-zinc-100/10 transition-colors"
                  >
                    <div className="whitespace-nowrap">Mobile Apps</div>
                  </Link>
                  <Link
                    href="/ai"
                    className="flex items-center justify-center border-b neu-separator text-zinc-900 font-normal text-[0.81rem] xl:text-[0.86rem] hover:bg-zinc-100/10 transition-colors"
                  >
                    <div className="whitespace-nowrap">AI/ML</div>
                  </Link>
                </div>
                ...
                <div className="grid grid-cols-4">
                  <Link
                    href="#contact"
                    className="flex items-center justify-center border-r neu-separator group hover:bg-zinc-100/10 transition-colors"
                  >
                    <div className="w-12 h-12 xl:w-14 xl:h-14 rounded-full flex items-center justify-center transition-colors text-rose-500 group-hover:opacity-100 opacity-90 group-hover:scale-110">
                      <svg
                        viewBox="0 0 24 24"
                        className="block w-6 h-6 xl:w-7 xl:h-7 fill-current"
                        xmlns="http://www.w3.org/2000/svg"
                        aria-hidden="true"
                      >
                        <path
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center group hover:bg-zinc-100/10 transition-colors"
                  >
                ...
                <div className="relative flex-1 flex flex-col justify-between">
                  ...
                  <div className="relative pl-6 group">
                    ...
                    <div className="space-y-0">
                      ...
                      <p className="text-[0.81rem] xl:text-[0.86rem] font-normal leading-[1.42] text-zinc-900 dark:text-zinc-100">
                        George Brown College, Toronto
                      </p>
                      <p className="text-[0.81rem] xl:text-[0.86rem] font-normal leading-[1.42] text-zinc-900 dark:text-zinc-100">
                        Postgraduate
