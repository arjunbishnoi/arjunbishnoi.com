      ...
      <div className="w-full max-w-md mx-auto px-6 mb-[clamp(1.25rem,4.5svh,3rem)] md:hidden">
        <div className="neu-container overflow-hidden pt-3">
          ...
          <div className="grid grid-cols-2">
            <Link href="/apps" className="flex items-center h-[clamp(4.5rem,11svh,6rem)] border-r border-b neu-separator text-zinc-900 dark:text-zinc-100 font-semibold active:bg-zinc-100/10 transition-colors">
              <div className="w-1/2 flex justify-center">
                <div className="w-8 text-left whitespace-nowrap">Mobile Apps</div>
              </div>
            </Link>
            <Link href="/ai" className="flex items-center h-[clamp(4.5rem,11svh,6rem)] border-b neu-separator text-zinc-900 dark:text-zinc-100 font-semibold active:bg-zinc-100/10 transition-colors">
              <div className="w-1/2 flex justify-center">
                <div className="w-8 text-left whitespace-nowrap">AI Engineering</div>
              </div>
            </Link>
            <Link href="/design" className="flex items-center h-[clamp(4.5rem,11svh,6rem)] border-r border-b neu-separator text-zinc-900 dark:text-zinc-100 font-semibold active:bg-zinc-100/10 transition-colors">
              <div className="w-1/2 flex justify-center">
                <div className="w-8 text-left whitespace-nowrap">Design</div>
              </div>
            </Link>
            <a href={socialLinks.resume} download={socialLinks.resumeDownloadName} className="flex items-center h-[clamp(4.5rem,11svh,6rem)] border-b neu-separator text-zinc-900 dark:text-zinc-100 font-semibold active:bg-zinc-100/10 transition-colors">
              <div className="w-1/2 flex justify-center">
          ...
          <div className="grid grid-cols-4">
            <a href={socialLinks.email} className="flex items-center justify-center h-[clamp(4.5rem,11svh,6rem)] border-r neu-separator group active:bg-zinc-100/10 transition-colors">
            ...
            <a href="#contact" className="flex items-center justify-center h-[clamp(4.5rem,11svh,6rem)] border-r neu-separator group active:bg-zinc-100/10 transition-colors">
              <div className="w-12 h-12 rounded-full flex items-center justify-center transition-colors text-zinc-500 dark:text-zinc-400 group-hover:text-zinc-900 dark:group-hover:text-zinc-100">
                <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href={socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center h-[clamp(4.5rem,11svh,6rem)] border-r neu-separator group active:bg-zinc-100/10 transition-colors">
              <div className="w-12 h-12 rounded-full flex items-center justify-center transition-colors text-zinc-500 dark:text-zinc-400 group-hover:text-zinc-900 dark:group-hover:text-zinc-100">
                <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href={socialLinks.github} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center h-[clamp(4.5rem,11svh,6rem)] group active:bg-zinc-100/10 transition-colors">
              <div className="w-12 h-12 rounded-full flex items-center justify-center transition-colors text-zinc-500 dark:text-zinc-400 group-hover:text-zinc-900 dark:group-hover:text-zinc-100">
                <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
