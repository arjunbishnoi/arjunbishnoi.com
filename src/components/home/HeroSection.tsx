...
export function HeroSection() {
  ...
  return (
    ...
    >
          ...
          <div className="w-full neu-container overflow-hidden aspect-[342/340] grid grid-rows-[40%_20%_20%_20%]">
            ...
            <div className="grid grid-cols-4">
              ...
              <a href={socialLinks.github} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center border-r neu-separator group active:bg-zinc-100/10 transition-colors">
                <div className="w-11 h-11 rounded-full flex items-center justify-center transition-colors text-zinc-900 dark:text-zinc-100 group-hover:opacity-100 opacity-90">
              ...
              <a href={socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center group active:bg-zinc-100/10 transition-colors">
                <div className="w-11 h-11 rounded-full flex items-center justify-center transition-colors text-[#0A66C2] dark:text-[#5DA9FF] group-hover:opacity-100 opacity-90">
                  <svg viewBox="0 0 24 24" className="block w-[1.4rem] h-[1.4rem] fill-current" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="hidden lg:flex w-full z-20 pb-0 mt-12 xl:mt-14">
        <div className="w-full max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex w-full items-start justify-center gap-6 xl:gap-7">
            <div className="w-full max-w-[19.5rem] xl:max-w-[21rem] flex-shrink-0">
              <AboutProfileCard
            ...
            <div className="w-full max-w-[19.5rem] xl:max-w-[21rem] flex-shrink-0">
              <div className="w-full neu-container overflow-hidden aspect-[4/5] grid grid-rows-[40%_20%_20%_20%]">
              <div className="relative h-full p-3 pb-2.5">
                <Link
                  href="#contact"
                  className="group relative z-10 block w-full h-full rounded-[34px] overflow-hidden neu-raised neu-mobile-neumorphic transform-gpu"
                >
                  <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none animate-color-shift">
                    <div className="absolute inset-0 bg-[var(--neu-surface)]" />
                    <div
                  ...
                  <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
                    <div className="flex items-center gap-2.5">
                      <span className="text-[1.18rem] xl:text-[1.28rem] tracking-[-0.02em] font-semibold text-zinc-900 dark:text-white">
                        View all projects
                      </span>
                      <ArrowUpRight className="w-5 h-5 text-zinc-900 dark:text-white" strokeWidth={2.5} />
                    </div>
              ...
              <div className="grid grid-cols-2">
                <Link href="/apps" className="flex items-center justify-center border-r border-b neu-separator text-zinc-900 dark:text-zinc-100 font-medium text-[1.02rem] xl:text-[1.08rem] text-center transition-colors px-3">
                  <div className="whitespace-nowrap">Mobile Apps</div>
                </Link>
                <Link href="/ai" className="flex items-center justify-center border-b neu-separator text-zinc-900 dark:text-zinc-100 font-medium text-[1.02rem] xl:text-[1.08rem] text-center transition-colors px-3">
                  <div className="whitespace-nowrap">AI/ML</div>
                </Link>
              </div>

              <div className="grid grid-cols-2">
                <Link href="/design" className="flex items-center justify-center border-r border-b neu-separator text-zinc-900 dark:text-zinc-100 font-medium text-[1.02rem] xl:text-[1.08rem] text-center transition-colors px-3">
                  <div className="whitespace-nowrap">Design</div>
                </Link>
                <a href={socialLinks.resume} download={socialLinks.resumeDownloadName} className="flex items-center justify-center border-b neu-separator text-zinc-900 dark:text-zinc-100 font-medium text-[1.02rem] xl:text-[1.08rem] text-center transition-colors px-3">
                  <div className="whitespace-nowrap">Resume</div>
                </a>
              </div>

              <div className="grid grid-cols-4">
                <a href={socialLinks.email} className="flex items-center justify-center border-r neu-separator group transition-colors">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center transition-colors text-rose-500 dark:text-rose-400 group-hover:opacity-100 opacity-90">
                    <svg viewBox="0 0 24 24" className="block w-[1.55rem] h-[1.55rem] fill-current" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                      <path fillRule="evenodd" clipRule="evenodd" d="M7 2.75C5.38503 2.75 3.92465 3.15363 2.86466 4.1379C1.79462 5.13152 1.25 6.60705 1.25 8.5V15.5C1.25 17.393 1.79462 18.8685 2.86466 19.8621C3.92465 20.8464 5.38503 21.25 7 21.25H17C18.615 21.25 20.0754 20.8464 21.1353 19.8621C22.2054 18.8685 22.75 17.393 22.75 15.5V8.5C22.75 6.60705 22.2054 5.13152 21.1353 4.1379C20.0754 3.15363 18.615 2.75 17 2.75H7ZM19.2285 8.3623C19.5562 8.10904 19.6166 7.63802 19.3633 7.31026C19.1101 6.98249 18.6391 6.9221 18.3113 7.17537L12.7642 11.4616C12.3141 11.8095 11.6858 11.8095 11.2356 11.4616L5.6886 7.17537C5.36083 6.9221 4.88982 6.98249 4.63655 7.31026C4.38328 7.63802 4.44367 8.10904 4.77144 8.3623L10.3185 12.6486C11.3089 13.4138 12.691 13.4138 13.6814 12.6486L19.2285 8.3623Z" />
                    </svg>
                  </div>
                </a>
                <a href={socialLinks.behance} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center border-r neu-separator group transition-colors">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center transition-colors text-[#1769FF] dark:text-[#4D8DFF] group-hover:opacity-100 opacity-90">
                    <svg viewBox="-40 -40 3413 3413" className="block w-[1.55rem] h-[1.55rem] fill-current" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <a href={socialLinks.github} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center border-r neu-separator group transition-colors">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center transition-colors text-zinc-900 dark:text-zinc-100 group-hover:opacity-100 opacity-90">
                    <svg viewBox="0 0 24 24" className="block w-[1.55rem] h-[1.55rem] fill-current" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
                    </svg>
                  </div>
                </a>
                <a href={socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center group transition-colors">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center transition-colors text-[#0A66C2] dark:text-[#5DA9FF] group-hover:opacity-100 opacity-90">
                    <svg viewBox="0 0 24 24" className="block w-[1.55rem] h-[1.55rem] fill-current" xmlns="http://www.w3.org/2000/svg">
                      <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                    </svg>
                  </div>
