...
export function HeroSection() {
  ...
  return (
    <section
      className="relative overflow-hidden flex flex-col items-center justify-start pt-[5.5rem] md:pt-16 lg:pt-20 pb-14 md:pb-0"
      style={{ background: "var(--neu-surface)" }}
    >

      {/* Hero Title — vertically centered in the gap between header bar and cards */}
      <div className="w-full max-w-5xl mx-auto px-6 sm:px-6 text-center flex items-center justify-center h-[9.75rem] sm:h-[14rem] md:h-[16rem] lg:h-[18rem] xl:h-[20rem]">
        <h1
          className="font-serif max-md:font-extrabold font-bold md:font-semibold text-[1.75rem] sm:text-[2.5rem] md:text-[3.125rem] lg:text-[3.75rem] xl:text-[4.25rem] leading-[1.1] md:whitespace-nowrap inline-block px-4 -mx-4 pb-2.5 max-md:subpixel-antialiased max-md:[-webkit-text-stroke:0.6px_transparent] max-md:scale-y-[1.1] max-md:origin-center"
          style={{
      ...
      <div className="w-full max-w-md mx-auto px-6 mb-12 md:hidden">
        <div className="neu-container overflow-hidden pt-3">
          {/* Top: Raised All Projects rectangle */}
          <div className="px-3">
            <Link
              href="/projects"
              className="group relative block rounded-[32px] h-40 overflow-hidden neu-raised neu-mobile-neumorphic transform-gpu p-1"
            >
              ...
              <div className="relative z-10 h-full flex flex-col items-center justify-center text-center">
                <div className="flex items-center gap-2">
                  <span className="text-xl font-bold text-zinc-900 dark:text-white">View All Projects</span>
          ...
          {/* Middle: Flat Grid of Categories (Consistent h-24 height) */}
          <div className="grid grid-cols-2">
            <Link href="/apps" className="flex items-center h-24 border-r border-b neu-separator text-zinc-900 dark:text-zinc-100 font-semibold active:bg-zinc-100/10 transition-colors">
              <div className="w-1/2 flex justify-center">
                <div className="w-8 text-left whitespace-nowrap">Mobile Apps</div>
              </div>
            </Link>
            <Link href="/ai" className="flex items-center h-24 border-b neu-separator text-zinc-900 dark:text-zinc-100 font-semibold active:bg-zinc-100/10 transition-colors">
              <div className="w-1/2 flex justify-center">
                <div className="w-8 text-left whitespace-nowrap">AI Engineering</div>
              </div>
            </Link>
            <Link href="/design" className="flex items-center h-24 border-r border-b neu-separator text-zinc-900 dark:text-zinc-100 font-semibold active:bg-zinc-100/10 transition-colors">
              <div className="w-1/2 flex justify-center">
                <div className="w-8 text-left whitespace-nowrap">Design</div>
              </div>
            </Link>
            <a href={socialLinks.resume} download={socialLinks.resumeDownloadName} className="flex items-center h-24 border-b neu-separator text-zinc-900 dark:text-zinc-100 font-semibold active:bg-zinc-100/10 transition-colors">
              <div className="w-1/2 flex justify-center">
          ...
          {/* Bottom: Social Icons Row (Consistent h-24 height) */}
          <div className="grid grid-cols-4">
            <a href={socialLinks.email} className="flex items-center justify-center h-24 border-r neu-separator group active:bg-zinc-100/10 transition-colors">
              <div className="w-12 h-12 rounded-full flex items-center justify-center transition-colors text-zinc-500 dark:text-zinc-400 group-hover:text-zinc-900 dark:group-hover:text-zinc-100">
            ...
            <a href="#contact" className="flex items-center justify-center h-24 border-r neu-separator group active:bg-zinc-100/10 transition-colors">
              <div className="w-12 h-12 rounded-full flex items-center justify-center transition-colors text-zinc-500 dark:text-zinc-400 group-hover:text-zinc-900 dark:group-hover:text-zinc-100">
                <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href={socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center h-24 border-r neu-separator group active:bg-zinc-100/10 transition-colors">
              <div className="w-12 h-12 rounded-full flex items-center justify-center transition-colors text-zinc-500 dark:text-zinc-400 group-hover:text-zinc-900 dark:group-hover:text-zinc-100">
                <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href={socialLinks.github} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center h-24 group active:bg-zinc-100/10 transition-colors">
              <div className="w-12 h-12 rounded-full flex items-center justify-center transition-colors text-zinc-500 dark:text-zinc-400 group-hover:text-zinc-900 dark:group-hover:text-zinc-100">
                <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
