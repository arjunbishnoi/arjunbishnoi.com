      ...
      <div className="mx-auto max-w-7xl px-6 pt-6 sm:pt-8 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 items-start">
          ...
          <div className="md:col-span-4 flex justify-center md:justify-start">
            <div className="relative w-full md:max-w-xs aspect-square rounded-2xl overflow-hidden border border-border/75 dark:max-md:border-white/5 md:dark:border-white/10 bg-gray-50/60 dark:bg-card/20 backdrop-blur-sm">
              <Image 
